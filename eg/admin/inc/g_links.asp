<link type="text/css" rel="stylesheet" rev="contents" media="screen" href="../css/Rezo_global.css" />
<link type="text/css" rel="stylesheet" rev="contents" media="screen" href="../css/Rezo_fonts.css" />
<script type="text/javascript" src="../js/jquery-1.8.3.min.js"></script>
<!--此处分别定义了了两套CSS, 自动判断浏览器语言进行加载,也可以手动修改-->
