...
toPage_="products_actt"&Request("act")&"_"&Isid(request("id"),0)&"_"&Isid(request("page"),1)&".html"

if Page=1 then 
	This_Func_Get_Html_=This_Func_Get_Html_& "<font color="&nonLinkColor_&" title=""首页"">"&toF_&"</font> " &vbNewLine
Else 
	This_Func_Get_Html_=This_Func_Get_Html_& "<a href="&toPage_&" title=""首页"">"&toF_&"</a> " &vbNewLine
End If 
...
page=Isid(request("page"),1)-1
	This_Func_Get_Html_=This_Func_Get_Html_& "<a href=""?act="&Request("act")&"&id="&Isid(request("id"),0)&"&page="&page&"""  title=""上一页"">"&toP1_&"</a> "  &vbNewLine
Else 
...
For I=StartPage To EndPage 
	If I=Page Then 
		This_Func_Get_Html_=This_Func_Get_Html_& "<font color=""#ff0000""><B>"&I&"</B></font>"  &vbNewLine
	Else 
		This_Func_Get_Html_=This_Func_Get_Html_& "<a href=""?act="&Request("act")&"&id="&Isid(request("id"),0)&"&page="&I&""">" &I& "</a>"  &vbNewLine
	End If 
...
page=Isid(request("page"),1)+1
	This_Func_Get_Html_=This_Func_Get_Html_& " <a href=""?act="&Request("act")&"&id="&Isid(request("id"),0)&"&page="&page&""" title=""下一页"">"&toN1_&"</a> "  &vbNewLine
Else 
...
Page=Page_Rs.PageCount 
	This_Func_Get_Html_=This_Func_Get_Html_& "<a href=""?act="&Request("act")&"&id="&Isid(request("id"),0)&"&page="&page&""" title=""尾页"">"&toL_&"</a>"  &vbNewLine
Else 
...
This_Func_Get_Html_=This_Func_Get_Html_& p_&sp2_&""&Page_Rs.PageSize&"条/页，<span class=""tx"">页数："&sp2_&Page&"</span>/"&tPageCount&"，共<span id='recordcount'>"&sp2_&Page_Rs.recordCount&"</span>条记录"
