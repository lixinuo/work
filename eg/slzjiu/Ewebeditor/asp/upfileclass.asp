...
Class UpFile_Class
	...
	Public Sub GetData(MaxSize)
		...
		'
		'**************************************2010/7/20
        dim BytesRead,ChunkReadSize,DataPart,PartSize
        BytesRead = 0
        ...
        Do While BytesRead < Request.TotalBytes
            ...
            If PartSize + BytesRead > Request.TotalBytes Then PartSize = Request.TotalBytes - BytesRead
            DataPart = Request.BinaryRead(PartSize)
            oUpFileStream.Write DataPart
